class AddFieldsToRestoredObjects < ActiveRecord::Migration[5.1]
  def change
    ...
    add_column :restored_objects, :units_id, :integer
    ...
    add_column :restored_objects, :in_inventory, :boolean
    ...
    add_column :restored_objects, :latitude, :float
    add_column :restored_objects, :longitude, :float
    ...
    add_column :restored_objects, :priority_id, :integer
